...
var schema_1 = __importDefault(require("./libs/schema"));
var upload_1 = __importDefault(require("./route/upload"));
var app = new koa_1.default();
var router = new koa_router_1.default();
var rootDir = path_1.default.resolve(process.cwd(), './../client/out');
...
app.use(koa_static_1.default(rootDir));
        ...
        switch (_a.label) {
            case 0:
                if (!(ctx.status === 404 &&
                    ...
                    ctx.path.indexOf('/upload') !== 0)) return [3 /*break*/, 2];
                return [4 /*yield*/, koa_send_1.default(ctx, 'index.html', {
                        root: rootDir,
                    })];
            case 1:
                _a.sent();
...
var apollo = new apollo_server_koa_1.ApolloServer({
    schema: schema_1.default,
});
router.use('/upload', upload_1.default.routes());
router.get('/graphql', apollo.getMiddleware());
router.post('/graphql', apollo.getMiddleware());
apollo.applyMiddleware({ app: app, cors: false });
exports.default = app;
